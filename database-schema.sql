...
create table if not exists public.leads (
  ...
  -- Estados usados por el panel: new, review, contacted, quote_sent, closed.
...
begin
  alter table public.leads
    ...
    check (status in ('new', 'review', 'contacted', 'quote_sent', 'closed'));
...
begin
  alter table public.leads
    ...
    check (source in ('website', 'contact_form', 'chatbot'));
exception when duplicate_object then null;
end $$;
...
begin
  alter table public.chat_sessions
    add constraint chat_sessions_lead_status_allowed
    check (lead_status in ('new', 'review', 'contacted', 'quote_sent', 'closed'));
exception when duplicate_object then null;
end $$;
...
with check (status = 'new' and source in ('website', 'contact_form', 'chatbot'));
